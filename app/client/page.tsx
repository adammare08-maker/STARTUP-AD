...
export default async function ClientPage() {
  ...
  if (auth.state !== 'ready') return <main className="portal-shell"><a className="brand" href="/">STARTUP<span>/</span>AD</a><BackHome /><div className="setup-notice"><h1>Espace client bientôt disponible</h1><p>L’authentification sécurisée doit encore être reliée au projet Supabase de STARTUP/AD.</p></div></main>;
