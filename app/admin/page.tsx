...
export default async function AdminPage() {
  ...
  if (auth.state !== 'ready') return <main className="portal-shell"><a className="brand" href="/">STARTUP<span>/</span>AD</a><BackHome /><div className="setup-notice"><h1>Espace Adam non activé</h1><p>Configurez Supabase, exécutez la migration, créez votre compte puis attribuez-lui manuellement le rôle admin.</p></div></main>;
