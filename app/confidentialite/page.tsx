export default function PrivacyPage() {
  return <main className="legal-page">
    ...
    <div className="legal-notice"><strong>Vos demandes</strong><p>Pour toute question ou demande liée à vos données, utilisez le formulaire de contact afin d’écrire directement à Adam. Les modalités précises d’exercice des droits et les durées de conservation devront être complétées avant l’ouverture publique.</p></div>
    <div className="legal-notice"><strong>Connexion facultative avec Google</strong><p>Si vous choisissez Google lorsque cette option est activée, Google et Supabase traitent votre authentification. Supabase reçoit les informations de votre profil autorisées par Google, notamment votre identifiant, votre email et votre nom, pour créer ou retrouver votre compte STARTUP/AD. STARTUP/AD ne reçoit pas votre mot de passe Google et ne demande pas l’accès à vos messages Gmail ni à vos fichiers Drive. La connexion par email reste disponible.</p></div>
